import styles from './ChocolatesSummary.module.css'
...
const ChocolatesSummary = () => {
  return <section className={styles.summary}>
    ...
    <p>
      ...
      <p>
        All our chocolates are prepared with high-quality ingredients, custom-made and
        of course by experienced chefs!
      </p>
  </section>
}

export default ChocolatesSummary